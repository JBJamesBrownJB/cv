...
test('git-graph node Y stays aligned to its station after scrolling below the fold', async ({ page }) => {
  ...
  // scroll deep to the live branch, then assert the lowest committed node (c-sims) stays aligned.
  // (Schroders is the live HEAD — spark terminus only, no commit circle.)
